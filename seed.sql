...
INSERT INTO resources (id, type, title, description, url, is_ada, theme_id, created_at, update_at)
VALUES
...
(4, 'projet', 'Créer une API en node', 'Projet node', 'https://example.com/node',  false, 2,'2025-02-28 12:05','2025-02-28 12:05');
